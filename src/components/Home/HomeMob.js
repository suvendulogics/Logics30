...
const IRSManual = () => {
  ...
  const openLink = () => {
    const link =
      "https://irslogics.zendesk.com/hc/en-us/categories/200174926-Video-Tutorials";
  ...
  return (
    <div id="welcome" className="welcomehome" style={{marginBottom:"150px"}}>
      <div id="example">
      ...
      <div className="panel-wrap hidden-on-narrow">
        <div id="teammates" className="widget" style={{ marginTop: "5px" }}>
          <h3>
            ...
            <FontAwesomeIcon
              icon={faChevronUp}
              className={`iconup ${isCollapsed ? "collapsed" : "expanded"}`}
            ...
            <div id="divAnnouncements">
              ...
              <div style={{ padding: "14px" }}>
                <p className="para_details">
                  ...
                  Designed to enhance your experience and streamline
                  interactions with your clients.
                </p>
                <p className="para_details">
                  Our client portal comes packed with incredible
                  functionalities. Such as,{" "}
                  <strong>Faster, Stable and Mobile Friendly</strong>
                  <strong>
                    , Payment Feature, Customizable Theme, News and
                    Announcements, And Many More to Come
                  </strong>
                  .
                </p>
                <p className="para_details">
                  <span>
                    Our new client portal will revolutionize how you interact
                    with our services, providing a seamless and efficient
                    experience throughout your journey with us. We’re excited to
                    embark on this new chapter and look forward to serving you
                    better than ever before!
                  </span>
                </p>
                <p className="para_details">
                  <span>
                    Please reach out to our dedicated support line or email us
                    at support@logics.com for more information.
                  </span>
                </p>
              ...
              <div style={{ padding: "14px" }}>
                <p className="para_details">
                  ...
                  impacting our clients on <strong>21-Dec-2022</strong>{" "}
                  beginning <strong>10:00 PM</strong> <strong>CST</strong>.
                </p>
                <p className="para_details">
                ...
                <p className="para_details">
                  If you have any questions about the maintenance or which of
                  your services may be affected, please open a Ticket or email
                  us at support@logics.com, and we will be happy to help you
                  further.
                  {/* <br><br> */}
                </p>
              </div>
              ...
              <div style={{ padding: "14px" }}>
                <p className="para_details">
                  ...
                  deliverability and increased throughput in the new verified
                  A2P 10DLC ecosystem. A2P 10DLC comes with{" "}
                ...
                <p className="para_details">
                  ...
                  via standard 10-digit long-code (10DLC) phone numbers.
                  Carriers in the US consider all Logics traffic to be A2P.
                  Carriers’ A2P 10DLC offerings provide better delivery quality
                  and lower filtering risk than long code SMS of the past, using
        ...
        <div id="main-content">
          <div id="checklist" className="widget">
            <h3>
              ...
              <FontAwesomeIcon
                icon={faChevronUp}
                className={`icon_up ${isCollapsed ? "collapsed" : "expanded"}`}
                ...
                <ul className="ulchk">
                  ...
                  <li className="side_content">
                    ...
                    <div style={{ marginLeft: "20px" }}>
                      {" "}
                      Review your{" "}
                      <b className="bold_content">email notification</b>{" "}
                      settings. By default you receive all notification emails.
                    </div>
                    <br />
                    <div style={{ marginLeft: "20px" }}>
                      {" "}
                      Create your{" "}
                      <b className="bold_content">Email Signature</b>
                    </div>
                    <br />
                  </li>
                  <li className="side_content">
                    <FontAwesomeIcon
                      ...
                      className="right_arrow"
                    />
                    To create a <b className="bold_content">new case</b>, simply
                    double-click  <div  style={{ marginLeft: "22px" }}> on 'New Case' under 'Cases'</div> 
                  </li>
                  <li className="side_content">
                    <FontAwesomeIcon
                      icon={faArrowRight}
                      className="right_arrow"
                    />
                    Check out and test your current{" "}
                    <b className="bold_content">case filters</b>. <div  style={{ marginLeft: "20px" }}>Create new
                    filters if needed by double-clicking
                    <br />
                    on 'New Filter' under 'Cases'.</div>
                  </li>
                </ul>
                <ul id="ulAdminUser" className="ulchk">
                  <li className="side_content">
                    ...
                    <FontAwesomeIcon
                      ...
                      className="right_arrow"
                    />
                    To setup <b className="bold_content">additional users</b>,
                    visit{" "}<br/>
                  
               <div  style={{ marginLeft: "20px" }}>     <a
                      href=""
                    ...
                    >   User Management  </a>and click on 'New User'</div>
                ...
                <ul id="ulAdminGeneral" className="ulchk">
                  <li className="side_content">
                    ...
                    />
                    To setup{" "}
                    <b className="bold_content">custom forms and letters</b>,
                    visit{" "}
                    <div  style={{ marginLeft: "20px" }}>  <a
                      href=""
                    ...
                    >
                      Forms  Admin
                    </a>and follow the instructions on </div>
                    <div  style={{ marginLeft: "20px" }}>
                  
                     right panel.
                    
                    You can also watch the</div><div  style={{ marginLeft: "20px" }}>training video located in Tutorials section.</div> 
                  ...
                  <li className="side_content">
                    ...
                    />
                    To setup{" "}
                    <b className="bold_content">Lead Sources and Marketing</b>
                    <div  style={{ marginLeft: "20px" }}><b className="bold_content">Campaigns,</b>  visit{" "}   <a
                      href=""
                ...
                <ul id="ulAdminCompany" className="ulchk">
                  <li className="side_content">
                    ...
                    <br />
                    <div  style={{ marginLeft: "20px" }}> 
                    Complete or change your{" "}
                    <b className="bold_content">company profile</b> information.
                    Verify that your company's address,
                    <br />
                    phone &amp; fax numbers are entered correctly.
                    <br />
                    <br />
                    Upload your <b className="bold_content">company logo</b>.
                    (the logo is used in engagement letters and other custom
                    forms)
                    </div>
                  </li>
                </ul>

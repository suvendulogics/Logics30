           ...
           <div>
             <ul className="ulchk">
               ...
               <li className="side_content">
                 ...
                 double-click on <div  style={{ marginLeft: "20px" }}>'New Case' under 'Cases'</div> 
               </li>
               <li className="side_content">
                 <FontAwesomeIcon
                   icon={faArrowRight}
             ...
             <ul id="ulAdminUser" className="ulchk">
               <li className="side_content">
                 ...
                 <div  style={{ marginLeft: "20px" }}>    and click on 'New User' button.</div>
               </li>
             </ul>
             <ul id="ulAdminGeneral" className="ulchk">
               ...
               <li className="side_content">
                 ...
                 <div  style={{ marginLeft: "20px" }}>         visit{" "}
                 <a
                   href=""
            ...
            <HomeMob style={{marginBottom:"350px"}}/>
          )}
      </div>

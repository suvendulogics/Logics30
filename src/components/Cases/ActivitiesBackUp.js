    ...
    <div className={`activities ${isActivityCollapsed ? "collapsed" : ""}`}>
      <div className="header-title">
        <div className="header_section">
          ...
          <div className="arrow_div" onClick={handleActivityClick}>
            <FontAwesomeIcon
              icon={
      ...
      <div
        className={`header-view_new ${isActivityCollapsed ? "collapsed" : ""}`}
      >
                ...
                >
                  ...
                  <div>
                    <div className="pop_cont">
                      In order to create a new activity, this case needs to be
                      saved. Do you want to save this case?
                    </div>
            ...
            <div className="pops_open">
              ...
              <div>
                <div className="pop_sec_row">
                  ...
                  <div>
                    <div className="sec_cont" onClick={handleFilterClick}>
                    ...
                    <div>
                      {selectedType && (
                        <div style={{ display: "none" }}> {selectedType}</div>
                      )}
                    </div>
                  </div>
                </div>
  ...
  return (
    <div>
      ...
      <div>
        <textarea
          value={notes}
          style={{ height: "calc(100vh - 50px)", width: "99%", border: "none" ,
          resize: "none", }}
          onChange={handleNotesChange}
...
const Activities = () => {
  ...
  return (
    <div style={{height:"100%",backgroundColor:"#d0ddf0"}}>
      {isCollapsed && (
        <div>
          <Splitter
            style={{ height: "100vh" }}
      ...
      {!isCollapsed && (
        <div className="arrow_div" onClick={handleActivityClickfalse}>
          <FontAwesomeIcon

  ...
  return (
    <div id="welcome" className="welcomehome">
      ...
      <PanelBar expandMode="single">
          <PanelBarItem title="Latest Announcements" expanded={true}>
        <div id="teammates" className="widget" style={{ marginTop: "5px" }}>
          <h3>
            Latest Announcements{" "}
            <span className="collapse k-icon k-i-arrowhead-n"></span>
          </h3>
...
<PanelBarItem title="Before you start ..." expanded={true}>
        <div id="main-content" style={{ marginLeft: "15px" }}>
            ...
            <div >
              <ul className="ulchk">
                ...
                <li className="side_content">
                  ...
                  page to
                  <br/><br/>
                 {" "}{" "} Review your <b>email notification</b> settings. By default you
                  receive all notification emails.
                  <br/><br/>
                  Create your <b>Email Signature</b>
                  <br/><br/>
                </li>
                <li className="side_content">
                  <FontAwesomeIcon
                    ...
                    className="right_arrow"
                  />
                  To create a <b>new case</b>, simply double-click on 'New Case'
                  under 'Cases'
                </li>
                <li className="side_content">
                  <FontAwesomeIcon
                    ...
                    className="right_arrow"
                  />
                  Check out and test your current <b>case filters</b>. Create
              ...
              <ul id="ulAdminUser" className="ulchk">
                <li className="side_content">
                  ...
                  <FontAwesomeIcon
                    ...
                    className="right_arrow"
                  />
                  To setup <b>additional users</b>, visit{" "}
                  <a
                    href=""
              ...
              <ul id="ulAdminGeneral" className="ulchk">
                <li className="side_content">
                  <FontAwesomeIcon
                    ...
                    className="right_arrow"
                  />
                  To setup <b>custom forms and letters</b>, visit{" "}
                  <a
                    href=""
                ...
                <li className="side_content">
                  <FontAwesomeIcon
                    ...
                    className="right_arrow"
                  />
                  To setup <b>Lead Sources and Marketing Campaigns</b>, visit{" "}
                  <a
                    href=""
              ...
              <ul id="ulAdminCompany" className="ulchk">
                <li className="side_content">
                  ...
                  Complete or change your <b>company profile</b> information.
                  Verify that your company's address,
                  <br/>
                  phone &amp; fax numbers are entered correctly.
                  <br/><br/>
                  Upload your <b>company logo</b>. (the logo is used in

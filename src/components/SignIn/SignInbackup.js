...
refreshToken({email: "saumendra@irslogics.com", password: "irslogics123"}).then((res)=>{
  console.log("Test API Response ===>", res.data);
}).catch((error)=>{
  console.log("Error ===>", error.message);
})
            ...
            <div>
              <div className="btn_containerlog">
                {/* <GoogleLogin
                  ...
                  clientId="132481134279-nl0j8vrcokmqq6svtmh5t3mo8vuof4v0.apps.googleusercontent.com"
                ...
                >
                  <span className="google-icon">Log In with Google</span>
                </GoogleLogin> */}
                ...
                {/* <div className="btn_containerlog">
      <button onClick={handleMicrosoftLogin} className="google-login-button">
      <img src={Microsoft} className="image_google" />
        Sign in with Microsoft
        </button>
      {loginProvider === 'microsoft' && (
        <p>Logged in with Microsoft!</p>
      )}
    </div> */}
                {/* <div className="microsoft-login-button">
<MicrosoftLogin clientId="1c36548a-c7e9-44d6-b7d1-55bacebe2924" authCallback={authHandler} />
</div> */}
              </div>
            ...
            {/* <div className="btn_containerlog">
              <button onClick={renderLoginInfo} className="google_btn">
                <img src={Google} className="image_google" />
          ...
          {/* {emailError &&   !showForgotPasswordPopup && !showInfoPopup &&(
            <p className="error-message">Please input your email</p>
          )}
          {passwordError && !showForgotPasswordPopup && !showInfoPopup &&(
            <p className="error-message">Please input your password</p>
          )} */}
        </div>
